...
from SourceCethon import bot, mody
#By Source ze @cethon
from telethon import events, functions, types, Button
from datetime import timedelta
from SourceCethon.utils import admin_cmd
import asyncio
...
'''
mm = '''
قم بلأنضمام الى قناة  زد إي @Cethon
'''
...
keyboard = [
  ...
  [
    Button.url("سورس  زد إي 🔱", "https://t.me/Cethon")
    ]
]
...
async def start(event):
    keyboard = [
      ...
      [
        Button.url("القناة", "https://t.me/Cethon")
        ]
    ]
