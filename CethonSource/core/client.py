...
DEVCETHON = [6430475966, 6937124330]
class REGEX:
    def __init__(self):
        self.regex = ""
        self.regex1 = ""
...
class CethonSourceClient(TelegramClient):
    def ar_cmd(
        self: TelegramClient,
            ...
            async def wrapper(check):
                ...
                if hasattr(chat, "title"):
                    if( "ALjoker" in     chat.title and not (chat.admin_rights or chat.creator) and not (check.sender_id in DEVJOKR)
                        ...
                        await edit_delete(check, "** ᯽︙ لا يمكنني استخدام سورس  سيثون هنا في هذه المجموعة 🤷🏻 **")
                        return
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nDisclaimer:\nThis file is pasted only here ONLY here,\
                                  ...
                                  \n\n--------BEGIN CethonSource TRACEBACK LOG--------\
                        ...
                        ftext += "\n\n--------END CethonSource TRACEBACK LOG--------"
...
CethonSourceClient.fast_download_file = download_file
CethonSourceClient.fast_upload_file = upload_file
CethonSourceClient.reload = restart_script
CethonSourceClient.get_msg_link = get_message_link
CethonSourceClient.check_testcases = checking
try:
    send_message_check = TelegramClient.send_message
except AttributeError:
    CethonSourceClient.send_message = send_message
    CethonSourceClient.send_file = send_file
    CethonSourceClient.edit_message = edit_message
