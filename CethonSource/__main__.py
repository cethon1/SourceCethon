import sys
import Cethonsource
from Cethonsource import BOTLOG_CHATID, HEROKU_APP, PM_LOGGER_GROUP_ID
...
print(Cethonsource.__copyright__)
print("Licensed under the terms of the " + Cethonsource.__license__)

cmdhr = Config.COMMAND_HAND_LER

try:
    LOGS.info("جارِ بدء بوت سيثون ✓")
