...
from SourceCethon import bot
from SourceCethon.sql_helper.blacklist_assistant import (
    add_nibba_in_db,
    is_he_added,
    removenibba,
)
from SourceCethon.sql_helper.botusers_sql import add_me_in_db, his_userid
from SourceCethon.sql_helper.idadder_sql import (
    add_usersid_in_db,
    already_added,
    get_all_users,
)
    ...
    if event.sender_id == bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                                     ...
                                     [Button.url("المطـور 🔗", "https://t.me/King_aRnoLd"), Button.inline(
        ...
        await tgbot.send_message(
            ...
            link_preview=False,
            buttons=[
                [custom.Button.inline("تنـصيب سيثون  🐍", data="deploy")],
                [Button.url("تحتاج مسـاعدة ❓", "https://t.me/King_ArnoLd")],
            ],
        )
...
async def help(event):
    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                [Button.url("شرح التنصيب 📺", "https://t.me/cethon")],
                [Button.url("كروب المساعدة ❓", "https://t.me/cethon1Support")],
            ],
        )
...
async def users(event):
    if event.query.user_id == bot.uid:
        ...
        with io.BytesIO(str.encode(users_list)) as tedt_file:
            tedt_file.name = "SourceCethon.txt"
...
async def settings(event):
    if event.sender_id == bot.uid:
        ...
        await event.answer("انت لا تستطيع استخدام البوت احصل على بوتك من @Cethon", alert=True)
